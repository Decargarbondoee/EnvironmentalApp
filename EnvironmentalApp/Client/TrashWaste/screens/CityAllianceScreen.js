    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <Image
                    source={require('../assets/CityAlliance_Logo.jpg')}
                    style={styles.logo}
                />
            ...
            <View style={styles.subscriptiontype}>
                <Text style={styles.Imagetext}>
                    <MaterialIcons name="location-on" size={15} color="black" /><Text>Duport Road, Paynesville City, Liberia</Text>
                </Text>
                <Text style={styles.Imagetext}>
                ...
                <TouchableOpacity onPress={() => handleLinkPress('mailto:transwaste@gmail.com')}>
                    <Text style={styles.Imagetext}>
                        <Entypo name="email" size={15} color="black" /> <Text style={styles.linkText}>transwaste@gmail.com</Text>
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => handleLinkPress('https://web.facebook.com/p/Transwaste-Recycling-Aggregates-Ltd-100057740646497/?_rdc=1&_rdr')}>
                    <Text style={styles.Imagetext}>
                        <FontAwesome name="facebook-f" size={15} color="black" /> <Text style={styles.linkText}>transwaste</Text>
                    </Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
